...
**Beer Block Registration Bot** — это профессиональная система для автоматизации регистрации и управления участниками пивного забега. Система включает **Telegram-бота** для участников и **административную панель** для организаторов с полным набором инструментов управления событиями.
